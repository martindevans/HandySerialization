...
{
    public static void WriteVariableInt64<T>(this T writer, long l)
        where T : struct, IByteWriter
    {
        writer.WriteVariableUInt64(l.ZigZag());
    }

    public static long ReadVariableInt64<T>(this T writer)
        where T : struct, IByteReader
    {
        return writer.ReadVariableUInt64().DecodeZigZag();
    }


    public static void WriteVariableUInt64<T>(this T writer, ulong u)
        where T : struct, IByteWriter
    {
        var count = 0;
